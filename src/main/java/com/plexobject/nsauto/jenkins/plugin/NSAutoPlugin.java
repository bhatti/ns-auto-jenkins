...
import com.plexobject.nsauto.jenkins.domain.ScoreInfo;
...
public class NSAutoPlugin extends Builder implements SimpleBuildStep {
    ...
    public void perform(Run<?, ?> run, FilePath workspace, Launcher launcher, TaskListener listener)
        ...
        try {
            UploadInfo upload = upload(listener, artifactsDir);
            //
            if (waitForResults) {
    ...
    private UploadInfo upload(TaskListener listener, File artifactsDir) throws IOException, ParseException {
